define([
    ...
    $.widget('boyko.askQuestionHandler', {
        ...
        ajaxSubmit: function() {
            if (!this.isSubmitTimeoutExceeded()) {
                return alert({
                    ...
                    content: $.mage.__(
                        'Please waite couple minutes for submit new one question'
                    )
                });
            }
            ...
            $.ajax({
                ...
                .fail(function() {
                    alert({
                        ...
                        content: $.mage.__(
                            'Your request can not be submitted right now. Please, contact us directly via email or phone to get your Sample.'
                        )
                    });
                })
                .always(function() {
        ...
        getLastSuccessRequestMoment: function() {
            var lastRequestTimestamp = $.mage.cookies.get(
